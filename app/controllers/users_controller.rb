class UsersController < ApplicationController
  ...
  def vendor_params
    params.require(:vendor).permit(:bank, :bank_account, :branch_code, :account_number, :family_name, :first_name, :post_number, :prefecture_id, :city,:address, :building_name, :created_at, :updated_at).merge(user_id: current_user.id)
  end
